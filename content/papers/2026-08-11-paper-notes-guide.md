...
read_at: "2026-08-11T09:00:00+08:00"
...
note_source_url: "https://github.com/zhw-zhang/paper-notes/blob/main/content/papers/2026-08-11-paper-notes-guide.md"
sharing: "public"
...
图片放到 `content/media/<paper-slug>/`，图注只需逐张写明图号、简短说明和来源，不再追加许可或版权状态。外部图片仍应确认可以公开使用；不明确时，改为链接到[论文原始页面](https://arxiv.org/)。
